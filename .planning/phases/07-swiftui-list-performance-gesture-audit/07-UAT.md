...
number: 1
name: C14-2 — VoiceOver Actions rotor exposes Duplicate/Delete on a History row
expected: |
  With VoiceOver on (device preferred over simulator), focus a History row and swipe
  through the Actions rotor: "Duplicate" and "Delete" are announced as actions.
  Activating Delete presents the confirmation dialog rather than deleting immediately.
