...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/fempter/Developer/drinkpulse/.claude/.gsd-surface.json`
(sibling to `/Users/fempter/Developer/drinkpulse/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/fempter/Developer/drinkpulse/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/fempter/Developer/drinkpulse/.claude/skills`).
...
`/Users/fempter/Developer/drinkpulse/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/fempter/Developer/drinkpulse/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/fempter/Developer/drinkpulse/.claude/.gsd-surface.json`
Install profile marker: `/Users/fempter/Developer/drinkpulse/.claude/.gsd-profile`
Skill dirs: `/Users/fempter/Developer/drinkpulse/.claude/skills/gsd-*/`
Engine module: `/Users/fempter/Developer/drinkpulse/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/fempter/Developer/drinkpulse/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
