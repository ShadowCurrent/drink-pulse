...
<reference>
@/Users/fempter/Developer/drinkpulse/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/fempter/Developer/drinkpulse/.claude/gsd-core/references/user-profiling.md` to load:
