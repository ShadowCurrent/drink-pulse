...
**Verification depth scales with `asvs_level`** (see @/Users/fempter/Developer/drinkpulse/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
