...
INSTALL_JS_GLOBAL="/Users/fempter/Developer/drinkpulse/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/fempter/Developer/drinkpulse/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
