...
```markdown
Read /Users/fempter/Developer/drinkpulse/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/fempter/Developer/drinkpulse/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/fempter/Developer/drinkpulse/.claude/agents/gsd-ui-checker.md for instructions.
...
@/Users/fempter/Developer/drinkpulse/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/fempter/Developer/drinkpulse/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/fempter/Developer/drinkpulse/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/fempter/Developer/drinkpulse/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
