...
```
Agent(
  prompt="Read /Users/fempter/Developer/drinkpulse/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/fempter/Developer/drinkpulse/.claude/gsd-core/templates/SECURITY.md`
