...
- **Global scope**: `/Users/fempter/Developer/drinkpulse/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/fempter/Developer/drinkpulse/.claude/notes/`)
...
2. Glob `/Users/fempter/Developer/drinkpulse/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/fempter/Developer/drinkpulse/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/fempter/Developer/drinkpulse/.claude/notes/` — works in any directory
