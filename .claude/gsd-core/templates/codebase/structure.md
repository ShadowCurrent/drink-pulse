...
- Usage: Reference from command with `@/Users/fempter/Developer/drinkpulse/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/fempter/Developer/drinkpulse/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/fempter/Developer/drinkpulse/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
