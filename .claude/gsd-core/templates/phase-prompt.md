...
<!-- For checkpoint task examples and patterns, see @/Users/fempter/Developer/drinkpulse/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/fempter/Developer/drinkpulse/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/fempter/Developer/drinkpulse/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/fempter/Developer/drinkpulse/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
